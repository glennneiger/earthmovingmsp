...
import { deleteStock, singleprodstockbyid } from "../../actions/stockActions";
...
class NewStockHistory extends Component {
  ...
  componentDidMount() {
    ...
    // this.props.getNewStockHistoryProdStockDates();
            ...
            Cell: row => (
              <span>
                <center>
                  <Link
                    target="_blank"
                    to={`/new-stock-history-by-date/${row.value}`}
    ...
    return (
      <div>
        ...
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item active">New Stock History</li>
        </ol>
...
NewStockHistory.propTypes = {
  ...
  getNewStockHistoryProdStockDates: PropTypes.func.isRequired,
